(function(){
  ...
  // window.addEventListener("touchend", cancelTouch, false);
  canvas.addEventListener("touchcancel", cancelTouch, false);
  canvas.addEventListener("touchmove", cancelTouch, false);
